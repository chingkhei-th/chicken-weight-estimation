...
MODEL_PATH = "../assets/model/best.pt" # update your path and model name
CSV_PATH = "../assets/datasets/area_weight.csv" # Update your path and csv file name
    ...
    while True:
        ...
        for r in results:
            ...
            for i, (box, mask) in enumerate(zip(boxes, masks)):
                label = labels[0]  # Assuming single class 'broiler'
                if label == 'broiler':
                    ...
                    cv2.putText(frame, f"Weight: {predicted_weight[0]:.2f}", (x1, y1 - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)

        # Display the total weight in the top-right corner
        cv2.putText(frame, f"Total Weight: {total_weight:.2f}", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
